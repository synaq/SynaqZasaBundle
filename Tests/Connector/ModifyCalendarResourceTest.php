...
class ModifyCalendarResourceTest extends ZimbraConnectorTestCase
{
    /**
     * @var ZimbraConnector
     */
    ...
    {
        $message = '<ModifyCalendarResourceResponse xmlns="urn:zimbraAdmin">
  <calresource name="foo@bar.com" id="SOME-ID">
    ...
    <a n="zimbraMailDeliveryAddress">mod.test.1@synaq.com</a>
    ...
    <a n="mail">mod.test.1@synaq.com</a>
    ...
    <a n="zimbraId">51ea43f2-890c-4fd8-acac-504b59abd17a</a>
    ...
    <a n="zimbraPrefSkin">something</a>
