...
class GetCalendarResourceTest extends ZimbraConnectorTestCase
{
    /**
     * @var ZimbraConnector
     */
     ...
     * @throws SoapFaultException
     */
    public function correctlyNormalisesAllAttributesFromZimbra()
    {
        $resource = $this->connector->getCalendarResource('bar@baz.net');
        $this->assertEquals('Location', $resource['zimbraCalResType']);
    }
    ...
    {
        $message = '<GetCalendarResourceResponse xmlns="urn:zimbraAdmin">
  <calresource name="delete.cr.test@domain.com" id="SOME-UNIQUE-ZIMBRA-ID">
    ...
    <a n="zimbraMailHost">host.domain.com</a>
    ...
    <a n="zimbraCreateTimestamp">20200807124709Z</a>
    ...
    <a n="zimbraAvailableSkin">something</a>
    ...
    <a n="zimbraMailDeliveryAddress">delete.cr.test@synaq.com</a>
    ...
    <a n="mail">delete.cr.test@synaq.com</a>
    ...
    <a n="zimbraId">78338733-3d4a-4727-88a3-33f4b461c595</a>
    ...
    <a n="zimbraMailTransport">lmtp:some.host.domain.com:7025</a>
    ...
    <a n="zimbraPasswordModifiedTime">20200807124709Z</a>
